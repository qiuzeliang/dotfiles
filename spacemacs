...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(deft org-autolist)

   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()

   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(pangu-spacing chinese-wbim)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; Possible values for Cannot load pyimlist-type are:
   ...
   ;; (default "C-M-m")
   dotspacemacs-major-mode-emacs-leader-key "C-M-z"
...
before packages are loaded."
  ...
  (spacemacs//set-monospaced-font "Consolas" "文泉驿等宽微米黑" 12 14)
